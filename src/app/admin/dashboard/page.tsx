import { Package, MapPin, Tag, Activity, ArrowRight } from "lucide-react";
    ...
    <div className="space-y-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
          ...
          <div>
            <h3 className="text-4xl font-black text-slate-900 mb-1">2</h3>
            <p className="text-slate-500 text-sm font-bold uppercase tracking-wide">Promo Aktif</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm">
          ...
          <div className="space-y-4">
            ...
            <Link href="/admin/dashboard/promos" className="flex items-center justify-between p-4 rounded-2xl bg-slate-50 hover:bg-accent-50 border border-slate-100 hover:border-accent-200 transition-colors group">
              <div className="flex items-center gap-4">
                <div className="bg-white p-2 rounded-xl shadow-sm"><Tag className="w-5 h-5 text-accent-500" /></div>
                <div>
                  <h4 className="font-bold text-slate-800 group-hover:text-accent-700">Kelola Promo</h4>
                  <p className="text-xs text-slate-500 font-medium">Buat banner promo spesial bulan ini.</p>
                </div>
              </div>
