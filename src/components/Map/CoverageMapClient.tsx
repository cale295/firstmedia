...
const CoverageMap = dynamic(() => import("./CoverageMap"), {
  ssr: false,
  loading: () => (
    <div className="w-full h-full min-h-[350px] sm:min-h-[400px] lg:min-h-[500px] bg-slate-100 animate-pulse flex items-center justify-center rounded-3xl border border-slate-200">
